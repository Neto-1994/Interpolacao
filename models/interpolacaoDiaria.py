    ...
    class InterpolarDiarias():
        def calcular(self, data1, data2, data3, nomearquivo, nomesalvar):
            ...
            while data3 <= data2:
                ...
                data_i = datetime.strptime(data3, "%Y-%m-%d")
                # Formatar horário para a planilha2, diminuindo um dia na data
                nova_data_hora = data_i - timedelta(days=1)
                # Formatar a nova data e hora de volta para string
                valor2 = nova_data_hora.strftime("%Y-%m-%d")
                ...
                if x1 == x2 and x2 == x3:
                    ...
                    if x2 == x3:
                        ...
                        # print("Passou no 3°..")
                # Formatar a nova data e hora de volta para string
                data_salvar = data_i.strftime("%Y-%m-%d")
